ClusterManager = function() {
    ...
    manager.getNodesInSameCluster = function(node, xProperty, yProperty) {
        ...
        if(properties[0] !== 'none') nodesInSameCluster = nodesInSameCluster.filter(n => n.data[properties[0]] === node.data[properties[0]]);
        if(properties[1] !== 'none') nodesInSameCluster = nodesInSameCluster.filter(n => n.data[properties[1]] === node.data[properties[1]]);
